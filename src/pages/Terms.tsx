    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>By using SnapCut AI, you agree to these terms. If you do not agree, please do not use the service.</p>
          <h2 className="text-lg font-semibold text-foreground">2. Service Description</h2>
          <p>SnapCut AI provides AI-powered background removal. We do not guarantee 100% accuracy for all images.</p>
